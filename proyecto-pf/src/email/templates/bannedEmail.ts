export const bannedEmail = (username: string) => `
                 ...
                 <tr>
                  <td align="center" valign="top" style="padding:0;Margin:0;width:481px">
                   <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                     ...
                     <tr>
                      <td align="left" class="es-m-txt-c" style="padding:0;Margin:0"><p style="Margin:0;mso-line-height-rule:exactly;font-family:Montserrat, sans-serif;line-height:21px;letter-spacing:0;color:#060606;font-size:14px">Hemos detectado actividades inadecuadas, que no cumplen con nuestras normas. Analizaremos la situacion y nos comunicaremos a la brevedad.</p></td>
                     </tr>
                   </table></td>
                 </tr>
               </table><!--[if mso]></td></tr></table><![endif]--></td>
